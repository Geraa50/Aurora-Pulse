...
- [ ] HUD: уровень + прогресс (плитки/звёзды)
...
| 1.4 | Выбор 3 одинаковых → удаление + прогресс, неуспех → возврат на поле | ✅ |
...
| 2.2 | HUD: уровень + прогресс-бар сверху | ✅ |
...
- [x] Фоновая музыка + SFX (own work, generated)
...
├── scripts/
│   ├── autoload/
│   │   └── game_state.gd          ✅ level, переходы сцен, сигналы
│   ├── board/
...
| Уровень | Что | Чем |
|---------|-----|-----|
| Unit | `is_tile_free`, `is_valid_triple`, обновление прогресса | GUT |
